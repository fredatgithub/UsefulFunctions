...
using WinFormApplicationUsageDemo.Properties;
...
namespace WinFormApplicationUsageDemo
{
  public partial class FormMain : Form
  {
    ...
    private SearchOption _searchOptionDirectories = SearchOption.TopDirectoryOnly;
    ...
    private void buttonGetdirectory_Click(object sender, EventArgs e)
    {
      ...
      labelListboxResultCount.Text = "Count: " + listBoxResult.Items.Count;
    }

    private void checkBoxAllDirectories_CheckedChanged(object sender, EventArgs e)
    {
      _searchOptionDirectories = checkBoxAllDirectories.Checked ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly;
    }
  }
}
